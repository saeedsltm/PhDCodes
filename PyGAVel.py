...
def plot(best, best_rs, best_v, best_d, best_r):
    ...
    for v,d,c,l in zip(vel_list, dep_list, colors, labels):
        ...
        if l == 'Min': ax.plot(array(xs),-array(ys), linewidth=1.2, color='k', linestyle=':', label=l)
        elif l == 'Max': ax.plot(array(xs),-array(ys), linewidth=1.2, color='k', linestyle='--', label=l)
